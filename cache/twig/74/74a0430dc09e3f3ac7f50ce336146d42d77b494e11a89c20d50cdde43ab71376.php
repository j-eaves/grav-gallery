...
class __TwigTemplate_79685e21329d7130663d13662388c56b9fc51627176e0cde842969d6e0327ac9 extends Twig_Template
{
...
($context["bytes"] ?? null) < ($context["terabyte"] ?? null))) {
    ...
    public function getpreview($__path__ = null, $__value__ = null, $__global__ = null, ...$__varargs__)
    {
        ...
        ";
                ...
                // line 38
                echo "        ";
                $context["real_path"] = ((($this->getAttribute(($context["value"] ?? null), "thumb", [], "any", true, true) &&  !(null === $this->getAttribute(($context["value"] ?? null), "thumb", [])))) ? ($this->getAttribute(($context["value"] ?? null), "thumb", [])) : ($this->getAttribute($this->getAttribute(($context["global"] ?? null), "admin", []), "getPagePathFromToken", [0 => ($context["path"] ?? null)], "method")));
                // line 39
                echo "        ";
...
{% block input %}
    ...
    {% endif %}
{% endblock %}
", "forms/fields/file/file.html.twig", "/Users/catherder/My_WebApps/grav-admin_quark_theme/user/plugins/admin/themes/grav/templates/forms/fields/file/file.html.twig");
    }
}
